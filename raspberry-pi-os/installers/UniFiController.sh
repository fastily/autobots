...
sudo apt update && sudo apt install -y ca-certificates apt-transport-https openjdk-8-jre-headless jsvc libcommons-daemon-java
...
sudo apt update && sudo apt install -y haveged unifi