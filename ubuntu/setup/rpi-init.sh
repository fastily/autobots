...
#: Apply custom settings for ubuntu server for raspberry pi 2/3. This isn't gauranteed to be 100% automatic; 
...
## Install packages
sudo apt update
sudo apt -y  install openjdk-11-jre-headless fail2ban
